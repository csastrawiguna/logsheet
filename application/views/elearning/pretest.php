      ...
      <div class="card">
        <form method="post" action="" id="formElearningExam">
          ...
          <div class="card-body">
            ...
            <input type="hidden" name="exam_pretest_start" value="<?= date("Y-m-d H-i:s"); ?>">
            <input type="hidden" id="pretest_duration" value="<?= $getQuestionaire[0]['test_duration']; ?>">
                ...
                <?php foreach ($getQuestionaire as $q) : ?>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class="text-bold">
                        <input type="hidden" name="examPrePost" value="pretest" readonly="">
                      ...
                      <?php foreach ($options as $row) : ?>
                        <div class="pretty p-default p-round my-2">
                          ...
                          <div class="state p-primary-o">
                            <label><span class="text-wrap"><?= $row['label']; ?></span></label>
                          </div>
                        </div><br>
                      <?php endforeach; ?>
                    </td>
...
<script type="text/javascript">
  ...
  const timeCase = document.getElementById("pretest_duration");
