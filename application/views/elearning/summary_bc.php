                    ...
                    <div class="tab-content" id="custom-tabs-one-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="custom-tabs-one-byCategory" role="tabpanel" aria-labelledby="custom-tabs-one-byCategory-tab">
                            <div class="row mb-2">
                                <form class="form-inline" method="post" id="formGetSummaryByCategory">
                                    ...
                                    <button type="button" id="btnSelectSummaryByCategory" class="btn btn-outline-primary mb-2">View Result</button>
                                </form>
                        ...
                        <div class="tab-pane fade" id="custom-tabs-one-summary" role="tabpanel" aria-labelledby="custom-tabs-one-summary-tab">
                            <div class="row mb-2">
                                <form class="form-inline" method="post" id="formGetSummaryResult">
                                    <div class="form-group mx-sm-2 mb-2">
                                        ...
                                        <select type="password" class="form-control custom-select" id="selectElearningSummaryStart" name="selectElearningSummaryStart">
                                            <?php foreach ($elearningList as $el) : ?>
                                                <option value="<?= $el['period']; ?>"><?= date('M-Y', strtotime($el['period'])); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <label for="selectElearningSummaryEnd" class="mx-3">to</label>
                                        <select type="password" class="form-control custom-select" id="selectElearningSummaryEnd" name="selectElearningSummaryEnd">
                                            <?php foreach ($elearningList as $el) : ?>
                                                <option value="<?= $el['period']; ?>"><?= date('M-Y', strtotime($el['period'])); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                            ...
                            <div class="mt-4 col-8" id="elearningSummaryTableSummary">
                                <table class="table table-sm table-hover" id="tableElearningSummaryTableSummary">
                                    <thead class="bg-light">
                                        <tr>
                                            <th>User</th>
                                            <?php
                                            $keys = array_keys($summaryResult[0]);
                                            for ($col = 1; $col < count($summaryResult[0]); $col++) :
                                    ...
                                    <tbody>
                                        <?php foreach ($summaryResult as $row) : ?>
                                            <tr>
                                            <?php
                                            for ($baris = 0; $baris < count($summaryResult[0]); $baris++) :
