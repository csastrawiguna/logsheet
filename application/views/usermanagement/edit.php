                    ...
                    <div class="row">
                        <form action="" method="POST" class="form-horizontal col-sm-10">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="" class="form-control" id="user_id" name="user_id" value="<?= $userDetail['user_id'] ?>" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="fullname" class="col-sm-2 col-form-label text-right">Fullname</label>
                                <div class="col-sm-8">
                                    <input type="" class="form-control" id="fullname" name="fullname" value="<?= $userDetail['fullname'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="birthdate" class="col-sm-2 col-form-label text-right">Birth date</label>
                                <div class="col-sm-3">
                                    <input type="date" class="form-control" id="birthdate" name="birthdate" value="<?= $userDetail['birthdate'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="npk" class="col-sm-2 col-form-label text-right">NPK</label>
                                <div class="col-sm-3">
                                    <input type="" class="form-control" id="npk" name="npk" value="<?= $userDetail['npk'] ?>">
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <select type="" class="custom-select form-control" id="status" name="status">
                                        <option value="<?= $userDetail['status'] ?>" selected><?= $userDetail['status'] ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input type="date" class="form-control" id="joindate" name="joindate" value="<?= $userDetail['joindate'] ?>">
                                </div>
                                <label for="retiredate" class="col-sm-2 col-form-label text-right">Retire date</label>
                                <div class="col-sm-3">
                                    <input type="date" class="form-control" id="retiredate" name="retiredate" value="<?= $userDetail['retiredate'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="emailAddress" class="col-sm-2 col-form-label text-right">Email</label>
                                <div class="col-sm-8">
                                    <input type="" class="form-control" id="emailAddress" name="emailAddress" value="<?= $userDetail['email_address'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="emailPersonal" class="col-sm-2 col-form-label text-right">Email personal</label>
                                <div class="col-sm-8">
                                    <input type="" class="form-control" id="emailPersonal" name="emailPersonal" value="<?= $userDetail['email_personal'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="userMoodle" class="col-sm-2 col-form-label text-right">User Moodle</label>
                                <div class="col-sm-4">
                                    <input type="" class="form-control" id="userMoodle" name="userMoodle" value="<?= $userDetail['user_moodle'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5" style="min-width: 374px; max-width: 380px;">
                                    <select type="" class="js-example-basic-single custom-select" id="deptjobdesk" name="deptjobdesk">
                                        <option value="<?= $userDetail['jobcode'] ?>"><?= $userDetail['jobdesk'] ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5" style="min-width: 374px; max-width: 380px;">
                                    <select type="" class="js-example-basic-single custom-select" id="role_access" name="role_access">
                                        <option value="<?= $userDetail['role_access'] ?>"><?= $userDetail['role_name'] ?></option>
                                ...
                                <div class="col-sm-3">
                                    <div class="pretty p-svg p-curve mt-2">
                                        <div class="pretty p-svg p-curve p-toggle">
                                            <input type="checkbox" name="is_active" id="is_active" value="<?= invert($userDetail['is_active']) ?>">
                                            <div class="state p-primary p-primary-o <?= statusToNegative($userDetail['is_active']) ?>">
                                                <svg class="svg svg-icon" viewBox="0 0 20 20">
                                                    <path d="M7.629,14.566c0.125,0.125,0.291,0.188,0.456,0.188c0.164,0,0.329-0.062,0.456-0.188l8.219-8.221c0.252-0.252,0.252-0.659,0-0.911c-0.252-0.252-0.659-0.252-0.911,0l-7.764,7.763L4.152,9.267c-0.252-0.251-0.66-0.251-0.911,0c-0.252,0.252-0.252,0.66,0,0.911L7.629,14.566z" style="stroke: white;fill:white;"></path>
                                                </svg>
                                                <label>Active</label>
                                            </div>
                                            <div class="state p-danger p-danger-o <?= statusToPositive($userDetail['is_active']) ?>">
                                                <svg class="svg svg-icon" viewBox="0 0 20 20">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5" style="min-width: 374px; max-width: 380px;">
                                    <select type="" class="js-example-basic-single custom-select" id="replacement_for" name="replacement_for">
                                        <option value="<?= $userDetail['replacement_for'] ?>"><?= $userDetail['npk'] . ' - ' . $userDetail['replacement_for'] ?></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="" class="form-control" id="mpr_approval" name="mpr_approval" value="<?= $userDetail['mpr_approval'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="user_edit_remark" class="col-sm-2 col-form-label text-right">Remark</label>
                                <div class="col-sm-8">
                                    <input type="" class="form-control" id="user_edit_remark" name="user_edit_remark" value="<?= $userDetail['remark'] ?>">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-2"></div>
                                <div class="col-sm-8">
                                    <button type="submit" class="btn btn-outline-primary mr-1">Update</button>
