            ...
            <div class="card">
                <div class="card-header bg-info">
                    ...
                    <div class="card-tools">
                        ...
                        <a href="#" data-toggle="modal" data-target="#modalSkapeFeedback" class="text-white mr-3"><i class="fas fa-comment"></i> Feedback SKAPE</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                                    ...
                                    <?php if($row['userid'] == $this->session->userdata('user_id')) : ?>
                                        <div class="direct-chat-msg right float-right mt-2" style="max-width: 80%; min-width: 45%" id="chat<?= $row['id'] ?>">
                                            <div class="direct-chat-infos clearfix">
                                                ...
                                                <a href="#" data-target="#modalEditMessage" data-toggle="modal" class="btnEditChatMessage text-secondary ml-2" data-id="<?= $row['id'] ?>" data-issticky="<?= $row['is_sticky'] ?>">
                                                ...
                                                <div class="pretty p-icon p-toggle p-plain repliedtoButton" style="opacity: 0.5; <?= tag2ReplyButton($row['tagged_by'], $row['userid'], $this->session->userdata('user_id')) ?>">
                                                    <input type="radio" name="repliedtoId" id="" value="<?= $row['id'] ?>">
                    ...
                    <form method="post" action="">
                        ...
                        <div class="row mt-3 d-flex justify-content-end">
                            ...
                            <?php if (in_array($this->session->userdata('role_access'), $allowSticky)) : ?>
                                ...
                                <div class="col-sm-2 form-inline float-right">
                            ...
                            <?php endif; ?>
                            <div class="col-sm-2">
                                <button type="button" name="buttonChatSubmit" id="buttonChatSubmit" class="float-right btn btn-primary">Send Message</button>
                            </div>
...
<div class="modal fade" id="modalSkapeFeedback" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="modalSkapeFeedbackLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?= base_url('chat/skapefeedback') ?>">
                <div class="modal-body">
                    <div class="form-group">
