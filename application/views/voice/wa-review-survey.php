                    ...
                    <div class="col-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="voiceSurveyFormVoiceNumber" class="text-muted">WA # (current)</label>
                                    <input type="" class="form-control text-center" id="voiceSurveyFormVoiceNumber" value="0" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="voiceSurveyFormCurrentScore" class="text-muted">Current WA score</label>
                        ...
                        <div class="card" id="voiceSurveyFormContainer">
                            ...
                            <div class="card-body">
                                <div class="form-group row border-bottom pb-3">
                                    <label for="voiceSurveyFormCallDate" class="col-sm-2 col-form-label" style="max-width: 110px; min-width: 100px">Conversation date</label>
                                ...
                                <!-- Greeting -->
                                <div class="form-group row border-bottom pb-3">
                                    <label for="voiceSurveyFormGreetingGood" class="col-sm-2 col-form-label" style="max-width: 110px; min-width: 100px">Response</label>
                                    <div class="col-sm-9">
                                        <div class="mb-2">
                                            <div class="pretty p-svg p-curve">
                                                ...
                                                <div class="state p-success">
                                                    ...
                                                    <label>OK / Bagus <em class="text-muted"> - Respon balasan < 1 menit</em></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="mb-2">
                                ...
                                <!-- Wording -->
                                <div class="form-group row border-bottom pb-3">
                                    <label for="voiceSurveyFormSmileGood" class="col-sm-2 col-form-label" style="max-width: 110px; min-width: 100px">Wording</label>
                                    <div class="col-sm-9">
                                        <div class="mb-2">
                                            <div class="pretty p-svg p-curve">
                                ...
                                <div class="form-group row border-bottom pb-3">
                                    <label for="voiceSurveyFormVoiceFile" class="col-sm-2 col-form-label" style="max-width: 110px; min-width: 100px">Chat File</label>
                                    <div class="col-sm-9">
                                        <input type="file" accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel" class="form-control" id="voiceSurveyFormVoiceFile" name="voiceSurveyFormVoiceFile" placeholder="">
