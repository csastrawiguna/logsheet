...
<head>
    ...
    <!-- FullCalendar -->
    <link rel="stylesheet" href="<?= base_url(); ?>assets/fullcalendar5110/main.css">
    <script src="<?= base_url(); ?>assets/fullcalendar5110/main.js"></script>
    <!-- Sweet alert -->
    ...
    <div class="wrapper">
        <div class="preloader">
            <div class="loading">
                ...
                <p class="text-center text-danger mt-3">Loading...</p>
            </div>
        </div>